            ...
            @if (auth()->user()->role == 'admin' || auth()->user()->role == 'super')
                <flux:sidebar.group :heading="__('Manajemen')" class="grid">
                    @if (auth()->user()->role == 'super')
                        <flux:sidebar.item icon="users" :href="route('super.users.index')"
                            :current="request()->routeIs('super.users*')" wire:navigate>
                            {{ __('Pengguna') }}
                        </flux:sidebar.item>
                    @endif

                    <flux:sidebar.item icon="tag" :href="route('admin.category.index')"
